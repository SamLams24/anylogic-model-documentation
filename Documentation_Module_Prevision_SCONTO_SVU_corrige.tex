...
\textbf{Backlog et réapprovisionnement.} Le réapprovisionnement autonome REAPPRO\_4 (19\,770 unités, statut EN\_COURS sur DATACO\_SPORTS au moment du relevé) explique la majeure partie de l'écart entre commandes générées et commandes closes sur cette famille. Dans cette configuration et au snapshot observé, le flux physique n'est pas encore éteint et un backlog important subsiste sur DATACO\_SPORTS : la demande générée excède momentanément la capacité de reconstitution et de traitement du scénario courant, ce qui prolonge l'extinction des flux au-delà de la fin de la campagne calendaire. Le run d'illustration (RUN 2) présente un constat de même nature, avec un ordre de réapprovisionnement EN\_COURS de 16\,013 unités sur la même famille. E5 permettra d'étudier les politiques de planification et de stock qui influent sur cette situation.
