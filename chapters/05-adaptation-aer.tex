...
L'AHP et le PI répondent à deux questions différentes. L'AHP est une méthode d'aide multicritère à la décision fondée sur une hiérarchie et des comparaisons par paires \cite{saaty1990}. Dans le modèle, il classe des options dans une situation locale ou tactique. Son score dépend des critères et de la matrice de comparaison utilisés pour cet arbitrage. Le PI évalue l'exécution à partir de mesures transformées en métriques, puis en scores RL, RS, AG, CO et AM.
