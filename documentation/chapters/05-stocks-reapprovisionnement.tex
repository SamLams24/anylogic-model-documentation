...
Lorsque le seuil est franchi, la politique propose une quantité économique de commande, ou EOQ~\cite{harris1913,erlenkotter1990}, fondée sur la demande annuelle, le coût de lancement et le coût annuel de possession. L'implémentation borne ensuite cette proposition. Lorsqu'un carnet de commandes clientes est ouvert, la quantité ne dépasse pas son besoin net. Une autre borne limite la proposition par rapport à la taille moyenne des commandes.
