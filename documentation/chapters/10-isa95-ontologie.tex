...
Comment relier une activité simulée, l'équipement qui l'exécute et la preuve que cette exécution a bien eu lieu? Le modèle répond à cette question par une hiérarchie d'équipements de type ISA-95~\cite{isa2025} et par une paire d'ontologies qui distingue le vocabulaire général des faits propres à un run.
