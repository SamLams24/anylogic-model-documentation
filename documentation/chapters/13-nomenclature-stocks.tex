...
\FigureOrPlaceholder{documentation/figures/screenshots/ui_nomenclature.png}{Emplacement prévu pour une capture réelle de la vue Nomenclature et matières.}{fig:ui-nomenclature}

\FigureOrPlaceholder{documentation/figures/screenshots/ui_nomenclature_annotee.png}{Emplacement prévu pour un agrandissement annoté des quatre zones de la vue Nomenclature.}{fig:ui-nomenclature-annotee}
...
\FigureOrPlaceholder{documentation/figures/screenshots/ui_fiche_matiere.png}{Emplacement prévu pour une capture réelle des champs d'une fiche matière.}{fig:ui-fiche-matiere}
