...
\FigureOrPlaceholder{documentation/figures/screenshots/ui_json_zone.png}{Zone de sauvegarde et de chargement JSON.}{fig:ui-json-zone}
...
\FigureOrPlaceholder{documentation/figures/screenshots/ui_json_liste.png}{Liste des configurations JSON détectées.}{fig:ui-json-liste}
